...
class AddDeviceActivity : BaseActivity<FragmentAddDeviceBinding, AddDeviceViewModel>(AddDeviceViewModel::class.java) {
...
//        val deviceCount = devCountStr?.toString()?.toByteArray() ?: ByteArray(0)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            mEsptouchTask = EsptouchTask(byteSSID, bssid, bytePwd, this@AddDeviceActivity)
